...
It renames all the occurrences of g1_demo (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the g1_demo folder
        os.rename(
            os.path.join(root_dir_path, "exts", "g1_demo", "g1_demo"),
            os.path.join(root_dir_path, "exts", "g1_demo", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "g1_demo"), os.path.join(root_dir_path, "exts", new_name))
